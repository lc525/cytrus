...
\fi
\hypersetup{
pdfauthor = {Lucian Carata},
pdftitle = {Identificarea obiectelor bazata pe puncte de interes, in secvente video},
pdfsubject = {Prelucrare grafica},
pdfkeywords = {detectie de obiecte, puncte de interes, SURF }
}
\usepackage{memhfixc}
