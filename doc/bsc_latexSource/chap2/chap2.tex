...
\end{equation}
Având la dispoziþie imaginea integralã, calculul sumei pixelilor dintr-o regiune oarecare se poate realiza doar prin 4 operaþii matematice. Dacã vom considera regiunea pentru care dorim sã calculãm suma ca fiind limitatã de colþurile A,B,C ºi D (precum în Figura~\ref{fig:chap2:squarearea}):
\begin{equation}
\sum=A+C-(B+D)
